# -*- coding: utf-8 -*-
# Generated by Django 1.9.1 on 2018-10-14 17:37
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('written_datetime', models.DateTimeField(auto_now_add=True)),
                ('last_modified', models.DateTimeField(auto_now=True)),
                ('has_appointment', models.CharField(blank=True, choices=[(b'Y', b'Yes'), (b'N', b'No'), (b'?', b'Not yet')], help_text=b'Did the patient make an appointment?', max_length=1)),
                ('pt_showed', models.CharField(blank=True, choices=[(b'Y', b'Yes'), (b'N', b'No'), (b'?', b'Not yet')], help_text=b'Did the patient show up to the appointment?', max_length=1, null=True)),
                ...
                ('no_apt_reason', models.ForeignKey(blank=True, help_text=b"If the patient didn't make an appointment, why not?", null=True, on_delete=django.db.models.deletion.CASCADE, to='followup.NoAptReason')),
